...
<div class="list-item" tabindex="0">
  <div class="list-city">
    <h1 class = list-title><a href="/#/detail/${restaurant.id}">${restaurant.city}</a></h1>
  </div>
  <div class="list-name">
    ${restaurant.name} | Rating : ${restaurant.rating}/5
  </div>
  <img class="list-thumb" src="${restaurant.pictureId ? CONFIG.BASE_IMAGE_URL + restaurant.pictureId : 'https://restaurant-api.dicoding.dev/images/medium/'}" alt="${restaurant.name}" crossorigin="anonymous">
</div>
`;
...
<div class="detail-card" tabindex="0">
  ...
  <img class="detail-thumb" src="${restaurant.pictureId ? CONFIG.BASE_IMAGE_URL + restaurant.pictureId : 'https://restaurant-api.dicoding.dev/images/medium/'}" alt="${restaurant.name}" crossorigin="anonymous">
